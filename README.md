...
Short, shareable quizzes for a professional audience. One destination where every
quiz cross-promotes the others, and every result exports as a clean certificate
image with attribution baked in.
...
standalone HTML file per quiz plus a hub page, so each quiz is independently
hostable and works on any static host.
